...
/**
 * Created by will on 4/27/15.
 */
public class FileBasedRequest implements HttpServletRequest {
    ...
    @Override public void login(String s, String s2) throws ServletException {
